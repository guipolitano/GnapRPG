<div class="tab-pane fade show" id="caracteristicas" role="tabpanel" aria-labelledby="caracteristicas">
        ...
        <div class="card-deck" style="padding-top: 2px;">
            <div class="card text-white bg-transparent border-warning" style="margin-right:5px;">
                <div class="card-body" style="padding: 0;text-align: center; margin-bottom:0; font-size:40px">
                    --<sup style="color:firebrick; font-size:26px"></sup>
                </div>
            ...
            <div class="card text-white bg-transparent border-warning" style="margin-left:0px; margin-right:5px; height:10%">
                <div class="card-body" style="padding: 0;text-align: center; margin-bottom:0; font-size:40px">
                    --<sup style="color:#85d786; font-size:26px"></sup>
    ...
    <div class="row">
                ...
                <div class="row" style="padding-left:15px">
                    <div class="input-group" style="width:100%; padding-right:5px">
                        <div class="input-group-prepend">
                            <label class="input-group-text" style="padding: 5px;" for="inputGroupSelect01"><a href="#" data-toggle="modal" data-target="#mostrar-info"><i class="far fa-question-circle question-mark"></i></a>Método</label>
                        </div>
            ...
            <div class="form-group" style="margin-bottom:0px">
                <div class="row" style="padding-left:15px; padding-bottom:3px">
                    <div class="input-group" style="width:33%;">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="inputGroupSelect01" style="padding: 5px;"><a href="#" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="A Força mede seu poder muscular, sua força física. O modificador de Força será aplicado nas jogadas de ataque corpo-a-corpo;
                    ...
                    <div class="input-group" style="width:33%; padding-left:4px">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="inputGroupSelect01" style="padding: 5px;"><a href="#" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="A Destreza mede agilidade, reflexos, equilí- brio e coordenação motora. O modificador de Destreza será aplicado nas jogadas
                    ...
                    <div class="input-group" style="width:33%; padding-left:4px">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="inputGroupSelect01" style="padding: 5px;"><a href="#" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="A saúde e vigor físico do herói são representados pela Constituição. Seu modificador será aplicado a seus pontos de vida
                ...
                <div class="row" style="padding-left:15px; padding-bottom:3px">
                    <div class="input-group" style="width:33%;">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="inputGroupSelect01" style="padding: 5px;"><a href="#" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="A capacidade de pensar, raciocinar e resolver problemas é medida pela Inteligência. Você usará seu modificador de Inteligência
                    ...
                    <div class="input-group" style="width:33%; padding-left:4px">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="inputGroupSelect01" style="padding: 5px;"><a href="#" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="A Sabedoria representa a percepção e força de vontade, além de seu bom senso, intuição e sentidos. Não é a mesma coisa que
                    ...
                    <div class="input-group" style="width:33%; padding-left:4px">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="inputGroupSelect01" style="padding: 5px;"><a href="#" data-container="body" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="Carisma mede sua força de personalidade, magnetismo pessoal, charme, simpatia, capacidade de persuasão e beleza física. Seu
        ...
        <div class="col" style="padding-left:15px">
            <div class="row" style="margin:0px; font-size:17px;">
                <div style="padding: 0px;" class="col-sm-6">
                    <div style="width:auto;">R1: <span style="color: #85d786">15</span> (4,3,6,<span style="text-decoration:line-through; color:#9c3e3e">2</span>)</div>
                    <div style="width:auto;">R2: <span style="color: #85d786">13</span> (4,3,6,<span style="text-decoration:line-through; color:#9c3e3e">0</span>)</div>
                    <div style="width:auto;">R3: <span style="color: #85d786">17</span> (4,<span style="text-decoration:line-through; color:#9c3e3e">3</span>,6,4)</div>
                </div>
                <div class="col-sm-6" style="padding:0px">
                    <div style="">R4: <span style="color: #85d786">8</span> (<span style="text-decoration:line-through; color:#9c3e3e">0</span>,2,5,1)</div>
                    <div style="">R5: <span style="color: #85d786">15</span> (4,3,6,<span style="text-decoration:line-through; color:#9c3e3e">3</span>)</div>
                    <div style="">R6: <span style="color: #85d786">15</span> (4,3,6,<span style="text-decoration:line-through; color:#9c3e3e">3</span>)</div>
                </div>


            </div>
            <div class="row" style="margin:0px;">
                <button type="button" class="btn btn-warning" style="margin:0px;margin-top:5px; width:100%">ROLAR OS DADOS</button>
            </div>
    ...
    <div class="row" style="padding-left:15px;">
        <div class="form-group" style="padding-right:5px; width:49%">
            <div class="input-group">
                <div class="input-group-prepend">
                    <label class="input-group-text" for="inputGroupSelect01"><a href="#" data-toggle="modal" data-target="#mostrar-info"><i class="far fa-question-circle question-mark"></i></a>Raça</label>
                </div>
                <select class="custom-select" id="inputGroupSelect01">
                                    <option selected>Selecione...</option>
